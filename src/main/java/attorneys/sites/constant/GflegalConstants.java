...
public class GflegalConstants {
    ...
    public static final String BAR_ADMISSIONS = "div[class^=attorneyProfile] >ul";
    ...
    public static final String LOCATION = "div.attorneyProfileLocation";
    public static final String NAME = "div#containerPageTitle >h1";
